...
Cluster validity indices: The mean dispersion of a cluster is the mean of the squared distances of the
points of the cluster with respect to their barycenter. The Ball-Hall index is the
mean, through all the clusters, of their mean dispersion.
The Banfield Raftery index is the weighted sum of the logarithms of the traces of the cov matrix of each cluster.
